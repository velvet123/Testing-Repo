...
$gs_l_link_rels = sanitize_text_field( gs_logo_getoption( 'anchor_tag_rel', 'noopener' ) );
...
$disable_lazy_load = gs_logo_getoption( 'disable_lazy_load', 'off' );
$lazy_load_class = gs_logo_getoption( 'lazy_load_class', 'skip-lazy' );
