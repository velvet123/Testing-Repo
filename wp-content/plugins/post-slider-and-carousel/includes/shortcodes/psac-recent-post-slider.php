...
function psac_render_post_slider( $atts, $content = null ) {
	...
	<div class="psac-post-slider-wrp psac-slider-and-carousel psac-clearfix">
		<div class="psac-post-slider owl-carousel <?php echo 'psac-'.esc_attr( $design ); ?>" id="psac-slider-<?php echo $unique; ?>" data-conf="<?php echo htmlspecialchars(json_encode( $slider_conf )); ?>">
